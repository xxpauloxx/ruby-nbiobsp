...
hdrdir = $(topdir)
arch_hdrdir = /usr/include/x86_64-linux-gnu/ruby-2.2.0
PATH_SEPARATOR = :
...
LIBRUBYARG_STATIC = -lruby-2.2-static
empty =
OUTFLAG = -o $(empty) 
COUTFLAG = -o $(empty)
...
DEFS     = 
CPPFLAGS =  -D_FORTIFY_SOURCE=2 $(DEFS) $(cppflags)  -I/var/lib/gems/2.2.0/gems/rice-1.7.0/ruby/lib/include
CXXFLAGS = $(CFLAGS)  -Wall -g
ldflags  = -L. -Wl,-Bsymbolic-functions -Wl,-z,relro -L/build/ruby2.2-l9vij4/ruby2.2-2.2.3/debian/lib -fstack-protector -rdynamic -Wl,-export-dynamic  -L/var/lib/gems/2.2.0/gems/rice-1.7.0/ruby/lib/lib -lrice -lNBioBSP
dldflags =  
ARCH_FLAG = 
...
RUBY_INSTALL_NAME = $(RUBY_BASE_NAME)2.2

RUBY_SO_NAME = ruby-2.2
...
sitearch = $(arch)
ruby_version = 2.2.0
ruby = $(bindir)/$(RUBY_BASE_NAME)2.2
RUBY = $(ruby)
...
target_prefix = 
LOCAL_LIBS = 
LIBS = -lruby-2.2 -lpthread -lgmp -ldl -lcrypt -lm   -lc
ORIG_SRCS = nbiobsp.cpp
SRCS = $(ORIG_SRCS) 
OBJS = nbiobsp.o
HDRS = $(srcdir)/nbiobsp.h
TARGET = nbiobsp
TARGET_NAME = nbiobsp
